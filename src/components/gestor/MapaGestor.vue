<template>
  <div>
    <v-card id="map">
        ...
        >
            ...
            <div>
                ...
                <!-- JOBS EN CONSULTA -->
                <vl-layer-vector :z-index="4" v-if="estadoJob.includes('En consulta')">
                <vl-source-vector
                ...
                <!-- JOBS DESESTIMADOS -->
                <vl-layer-vector :z-index="5" v-if="estadoJob.includes('Desestimado')">
                <vl-source-vector
                ...
                <!-- JOBS CONCILIADOS -->
                <vl-layer-vector :z-index="10" v-if="estadoJob.includes('Conciliado')">
                <vl-source-vector
                ...
                <!-- JOBS CONSOLIDADO -->
                <vl-layer-vector :z-index="13" v-if="estadoJob.includes('Consolidado')">
                <vl-source-vector
            ...
            <div>
                ...
                <!-- ERRORES PENDIENTES -->
                <vl-layer-vector :z-index="2" v-if="estadoError.includes('Pendiente solución')">
                    <vl-source-vector
                    ...
                    <vl-style-box>
                        <vl-style-circle :radius="5">
                            <vl-style-fill :color="getColor('Pendiente solución')"></vl-style-fill>
                            <vl-style-stroke color="white" :width="3"></vl-style-stroke>
                        </vl-style-circle>
                    </vl-style-box>
                </vl-layer-vector>
                ...
                <vl-layer-vector :z-index="3" v-if="estadoError.includes('Solucionado')">
                    <vl-source-vector
                ...
                <vl-layer-vector :z-index="4" v-if="estadoError.includes('Desestimado')">
                    <vl-source-vector
                ...
                <!-- ERRORES RECHAZADOS -->
                <vl-layer-vector :z-index="5" v-if="estadoError.includes('Rechazados')">
                    <vl-source-vector
    ...
    <v-card class="toolPanelContainer">
      <h4 class="toolPanelTitle">FILTROS</h4>
      <v-card>
        <!-- FILTRO ESTADO JOB -->
        <v-list dense>
...
export default {
  ...
  methods: {
    ...
    getJobFromBD() {
      axios.get(`${process.env.VUE_APP_API_ROUTE}/jobs`)
      .then((data) => {
